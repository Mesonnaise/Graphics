...
namespace Engine{
  ...
  public:
    ...
    //Move to Image. SwapchainImage view is craeted by the swapchain class
  ...
  protected:
    ...
    constexpr void SetFence(VkFence fence){
      mFence=fence;
    }

    constexpr VkFence GetFence(){
      return mFence;
    }
  public:
