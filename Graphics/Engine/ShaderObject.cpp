...
static PFN_vkCreateShadersEXT pfCreateShader=nullptr;
static PFN_vkDestroyShaderEXT pfDestroyShader=nullptr;
...
static PFN_vkGetDescriptorSetLayoutBindingOffsetEXT pfGetDescriptorSetLayoutBindingOffsetEXT=nullptr;
...
static void loadExtensionPointers(DevicePtr &device){
  if(pfGetDescriptorSetLayoutBindingOffsetEXT==nullptr){
    pfCreateShader=reinterpret_cast<PFN_vkCreateShadersEXT>(
      vkGetDeviceProcAddr(device->Handle(),"vkCreateShadersEXT"));
    pfDestroyShader=reinterpret_cast<PFN_vkDestroyShaderEXT>(
      vkGetDeviceProcAddr(device->Handle(),"vkDestroyShaderEXT"));
